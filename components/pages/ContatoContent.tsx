    ...
    <div style={{ paddingTop: 'var(--nav-h)' }}>
      ...
      <header className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <p className="section-label mb-8">{t('contatoLabel')}</p>
      ...
      <main className="max-w-site mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            <div>
              <p className="section-label mb-4">{t('contatoEmailLabel')}</p>
              <a
            ...
            <div>
              <p className="section-label mb-4">{t('contatoLocationLabel')}</p>
